<header>
    ...
    <nav>
        <ul>
            <li><a href="{{ route('acceuil') }}" @class(["active"=> request()->route()->getName() ==
                    "acceuil"])>Accueil</a></li>
            <li><a href="{{ route('catalogue') }}" @class(["active"=> request()->route()->getName() ==
                    "catalogue"])>Catalogue</a></li>
            <li><a href="{{ route('history') }}">Historique</a></li>
            <li><a href="{{ route('contact') }}" @class(["active"=> request()->route()->getName() ==
                    "contact"])>Contact</a></li>

            @admin
            <div class="dropdown">
                <button class="btn bold btn-danger dropdown-toggle" type="button" id="dropdownMenuButton"
