            ...
            <section id="result-section">
                <form class="filtre-section" action="{{ request()->fullUrl() }}" method="get">
                    ...
                    <div class="filtre-group">
                        <h3 class="filtre-option-titre">
                            Transmission
                        </h3>
                        <div class="filtre-options">
                            <input type="checkbox" name="type_transmission" value="manuel" id="manuel"
                                @checked(request('type_transmission')==="manuel" )>
                            <label for="transmission">Manuel</label>
                        </div>
                        <div class="filtre-options">
                            <input type="checkbox" name="type_transmission" value="automatique" id="automatique"
                                @checked(request('type_transmission')==="automatique" )>
                    ...
                    <div class="filtre-group">
                        ...
                        <div class="filtre-options">
                            <input type="checkbox" name="type_carburant" value="gasoil" id="gasoil"
                                @checked(request('type_carburant')==="gasoil" )>
                            <label for="gasoil">Gasoil</label>
                        </div>
                        <div class="filtre-options">
                            <input type="checkbox" name="type_carburant" value="essence" id="essence"
                                @checked(request('type_carburant')==="essence" )>
