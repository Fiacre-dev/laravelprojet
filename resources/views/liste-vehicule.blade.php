                    ...
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control @error("prixNouveauVehicule") is-invalid  @enderror" name="prixNouveauVehicule" id="prixNouveauVehicule" value="{{ old("prixNouveauVehicule") }}" placeholder="40 000" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Quotion</label>
                            <input type="number" class="form-control @error("quotionNouveauVehicule") is-invalid  @enderror" name="quotionNouveauVehicule" id="quotionNouveauVehicule" value="{{ old("quotionNouveauVehicule") }}" placeholder="40 000" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Nombre de places</label>
                            <input type="number" class="form-control @error("nombrePlacesNouveauVehicule") is-invalid  @enderror" name="nombrePlacesNouveauVehicule" id="nombrePlacesNouveauVehicule" value="{{ old("nombrePlacesNouveauVehicule") }}" placeholder="5" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Nombre de véhicules</label>
                            <input type="number" class="form-control @error("nombreNouveauVehicule") is-invalid  @enderror" name="nombreNouveauVehicule" id="nombreNouveauVehicule" placeholder="40" value="{{ old("nombreNouveauVehicule") }}" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Année</label>
                            <input type="number" class="form-control @error("anneeNouveauVehicule") is-invalid  @enderror" name="anneeNouveauVehicule" id="anneeNouveauVehicule" placeholder="2020" value="{{ old("anneeNouveauVehicule") }}" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Prix siège enfant</label>
                            <input type="number" class="form-control @error("place_enfantNouveauVehicule") is-invalid  @enderror" name="place_enfantNouveauVehicule" id="place_enfantNouveauVehicule" value="{{ old("place_enfantNouveauVehicule") }}" placeholder="5 000" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Prix chauffeur</label>
                            <input type="number" class="form-control @error("chauffeurNouveauVehicule") is-invalid  @enderror" name="chauffeurNouveauVehicule" id="chauffeurNouveauVehicule" value="{{ old("chauffeurNouveauVehicule") }}" placeholder="10 000" required>
                          </div>
                          <label for="Transmission" class="mt-1">Transmission</label>
                          <div class="my-2">
                            <input type="radio" id="transmissionNouveauVehicule" class="@error("transmissionNouveauVehicule") is-invalid  @enderror"" name="transmissionNouveauVehicule" value="Manuel" checked>
                            <label class="form-check-label" for="manuelle">Manuelle</label>
                            <input type="radio" id="transmissionNouveauVehicule" class="@error("transmissionNouveauVehicule") is-invalid  @enderror"" name="transmissionNouveauVehicule" value="Automatique">
