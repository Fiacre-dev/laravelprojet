                    ...
                    <div class="div-1">
                        ...
                        <form action="{{ route("catalogue") }}" id="reservation-rapide" method="GET">
                            <div class="nb-de-place">
                                <label for="nb-de-place">Nb de place
                                    <i class="fa-solid fa-users"></i></label>
                            ...
                            <div class="date-debut">
                                <label for="date-debut">date de debut
                            ...
                            <div class="rowIcone">
                                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="45" viewBox="0 0 43 45"
                                    ...
                                    <g clip-path="url(#clip0_223_284)">
                                        <path
                                            d="M23.0109 39.004L5.72415 21.0481V24.7163C5.72415 25.6884 6.09496 26.6238 6.76595 27.3024L20.5212 41.5901C21.8985 43.0207 24.141 43.0207 25.5183 41.5901L36.4836 30.2003C37.8609 28.7697 37.8609 26.4404 36.4836 25.0098L23.0109 39.004Z"
                                            fill="#7B61FF" />
                                        <path
                                            d="M20.5212 32.4195C21.8985 33.8501 24.141 33.8501 25.5183 32.4195L36.4836 21.0298C37.8609 19.5992 37.8609 17.2698 36.4836 15.8392L22.7284 1.55157C22.0576 0.871674 21.1582 0.490077 20.221 0.487793L9.25566 0.487793C7.31333 0.487793 5.72415 2.13849 5.72415 4.156V15.5458C5.72415 16.5179 6.09496 17.4533 6.76595 18.1319L20.5212 32.4195ZM13.2286 5.9901C13.814 5.9901 14.3754 6.23165 14.7893 6.6616C15.2033 7.09155 15.4358 7.67469 15.4358 8.28273C15.4358 8.89078 15.2033 9.47392 14.7893 9.90387C14.3754 10.3338 13.814 10.5754 13.2286 10.5754C12.6432 10.5754 12.0818 10.3338 11.6679 9.90387C11.254 9.47392 11.0214 8.89078 11.0214 8.28273C11.0214 7.67469 11.254 7.09155 11.6679 6.6616C12.0818 6.23165 12.6432 5.9901 13.2286 5.9901Z"
                                            fill="#7B61FF" />
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_223_284">
                                            <rect width="42.3781" height="44.0185" fill="white"
                                                transform="translate(0.42688 0.487793)" />
                                        </clipPath>
                                    </defs>
                                </svg>
                            </div>
                ...
                <div class="ligne">
                    ...
                    <div class="manual">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" viewBox="0 0 22 24" fill="none">
                            <path
                                d="M13.3333 9.24752V17.1078M8.66666 9.24752V17.1078M6.33332 5.31736C6.33332 6.3597 6.82499 7.35935 7.70016 8.0964C8.57533 8.83345 9.76231 9.24752 11 9.24752C12.2377 9.24752 13.4247 8.83345 14.2998 8.0964C15.175 7.35935 15.6667 6.3597 15.6667 5.31736C15.6667 4.27502 15.175 3.27537 14.2998 2.53832C13.4247 1.80128 12.2377 1.38721 11 1.38721C9.76231 1.38721 8.57533 1.80128 7.70016 2.53832C6.82499 3.27537 6.33332 4.27502 6.33332 5.31736ZM1.66666 23.0031H20.3333V20.0554H1.66666V23.0031ZM5.16666 20.0554H16.8333V17.1078H5.16666V20.0554Z"
                                stroke="black" stroke-opacity="0.81" stroke-width="2" />
                        </svg>
